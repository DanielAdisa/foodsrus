...
const Expertise = () => {
  return (
    <section id="expertise">
        <h2 className="my-8 text-3xl tracking-tighter text-center lg:text-4xl">Our Expertise</h2>
        <div className="container px-4 mx-auto">
            {CUSINES.map((cusine, index) => (
                <div key={index} className="flex items-center py-2 border-b-4 border-dotted border-neutral-700/40">
